...
<![endif]-->
		...
		<script src="<%=contextPath%>/resource/assets/js/jquery.dataTables.min.js"></script>
		<script src="<%=contextPath%>/resource/assets/js/jquery.dataTables.bootstrap.js"></script>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				$('table th parser:checkbox').on('click' , function(){
					var that = this;
					$(this).closest('table').find('tr > td:first-child parser:checkbox')
					.each(function(){
